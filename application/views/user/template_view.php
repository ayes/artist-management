...
<nav class="navbar navbar-default navbar-collapse navbar-fixed-top" role="navigation">
 <!-- Brand and toggle get grouped for better mobile display -->
  ...
  <ul class="nav navbar-nav navbar">
    <li><a href="/user/booking"><span class="glyphicon glyphicon-time"></span> Booking</a></li>   
      </ul>
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown user-dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="/user-panel/logout"><span class="glyphicon glyphicon-off"></span> Log Out</a></li>
              </ul>
            </li>
    </ul>
